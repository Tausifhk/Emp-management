...
@WebServlet("/more")
public class FetchEmpDetailsController extends HttpServlet {
	private static final long serialVersionUID = 1L;
    public FetchEmpDetailsController() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			ResultSet employees = service.findById(id);

			request.setAttribute("employee", employees);
				
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/moreDetails.jsp");
